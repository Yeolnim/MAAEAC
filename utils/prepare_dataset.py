...
if __name__ == "__main__":
    ...
    repair_atepc_dataset('../atepc_datasets/2015/Restaurants.atepc.train.dat',
                         '../atepc_datasets/2015/Restaurants.atepc.train.dat')
    repair_atepc_dataset('../atepc_datasets/2015/Restaurants.atepc.test.dat',
                         '../atepc_datasets/2015/Restaurants.atepc.test.dat')

    repair_atepc_dataset('../atepc_datasets/2016/Restaurants.atepc.train.dat',
                         '../atepc_datasets/2016/Restaurants.atepc.train.dat')
    repair_atepc_dataset('../atepc_datasets/2016/Restaurants.atepc.test.dat',
                         '../atepc_datasets/2016/Restaurants.atepc.test.dat')
